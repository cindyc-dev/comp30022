  ...
  return (
    <AboutLayout>
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Application</strong> refers to Potato CRM, the software
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Potato CRM.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Potato CRM, accessible from{" "}
            <a
              href="https://comp30022.vercel.app/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://comp30022.vercel.app/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: chuahx@student.unimelb.edu.au</li>
      </ul> */}
    </AboutLayout>
  );
}
