...
function TermsAndConditions() {
  return (
    <AboutLayout>
      ...
      <p>Welcome to Potato CRM!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Potato CRM's Website, located at https://comp30022.vercel.app/.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Potato CRM if you do not agree to
      ...
      <p>
        ...
        subject to, prevailing law of au. Any use of the above terminology or
      ...
      <p>
        We employ the use of cookies. By accessing Potato CRM, you agreed to use
        cookies in agreement with the Potato CRM's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, Potato CRM and/or its licensors own the
        intellectual property rights for all material on Potato CRM. All
        intellectual property rights are reserved. You may access this from
        Potato CRM for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Potato CRM</li>
        <li>Sell, rent or sub-license material from Potato CRM</li>
        <li>Reproduce, duplicate or copy material from Potato CRM</li>
        <li>Redistribute content from Potato CRM</li>
      </ul>
      ...
      <p>
        ...
        Potato CRM does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Potato CRM,its agents and/or affiliates. Comments reflect
        the views and opinions of the person who post their views and opinions.
        To the extent permitted by applicable laws, Potato CRM shall not be
      ...
      <p>
        Potato CRM reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant Potato CRM a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Potato CRM; and (d) the link is
      ...
      <p>
        ...
        e-mail to Potato CRM. Please include your name, your organization name,
      ...
      <p>
        No use of Potato CRM's logo or other artwork will be allowed for linking
